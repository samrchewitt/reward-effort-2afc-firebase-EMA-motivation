...
var createDialog = function (scene, pageNo, titleTxt, mainTxt, buttonTxt) {
    ...
    background: scene.rexUI.add.roundRectangle(50, 0, 200, 400, 20, backgrCol),
    
    title: scene.rexUI.add.label({
        background: scene.rexUI.add.roundRectangle(50, 0, 50, 40, 20, titleCol),
...
var createLabel = function (scene, text) {
    return scene.rexUI.add.label({
        background: scene.rexUI.add.roundRectangle(0, 0, 150, 150, 20, buttonCol),
